...
import { CREATE_ARTICLE } from "../others/Messages";
...
function CreateBlog() {
    ...
    async function handleSubmit(e) {
        ...
        const { title, author, category, faqs, slug, readTime, interested, view, share, smalldesc, bottom_section, internal_section, meta_key, meta_description, meta_title, meta_robots } = state;
        ...
        try {
            const res = await fetch(`${import.meta.env.VITE_URL}/blogs`, {
                method: "POST",
                headers: {
            ...
            if (res.status === 200) {
                ...
                LogsFunction(CREATE_ARTICLE + state.slug)
                if (response.success) {
                ...
                <div className="create-blog-body">
                    <div className="d-flex row">
                        ...
                        <div className="d-flex align-items-center justify-content-center">
                            <strong className="h5"><u>Page Content</u></strong>
                        </div>
                        ...
                        <select className='input-text' name="category" onChange={handleChange}>
                        ...
                        <select className='input-text mt-4' name="author" onChange={handleChange}>
                        ...
                        <div>
                            ...
                            <div className="col-lg-12 input-text faq-preview m-0">
                                {state.internal_section.map((faq, index) => (
                                    <div className="d-flex justify-content-between  input-text  my-2" key={index}>
                                        <li key={index} className="list-group-item">
                                            <strong>Q: </strong> {faq.question}
                                            <br />
                    ...
                    <div className="d-flex justify-content-end mt-4">
                        <button className="purplebtn" type="button" onClick={handleSubmit}>Create Blog </button>
                    </div>
                </div>
            </div>
            {
